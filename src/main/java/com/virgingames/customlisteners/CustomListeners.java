package com.virgingames.customlisteners;
...
import com.virgingames.utility.extentreport.ExtentReportManager;
import org.testng.ITestContext;
import org.testng.ITestListener;
import org.testng.ITestResult;
import org.testng.Reporter;

import static com.virgingames.utility.Utility.takeScreenShot;
...
public class CustomListeners implements ITestListener {
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        test = reports.createTest(iTestContext.getAllTestMethods()[0].getInstance().getClass().getSimpleName())
                .assignAuthor("Chetan").assignCategory("Smoke");
    }
